...
pub struct CardContainer {
    all_cards: Option<HashMap<u32, &'static (ICard + 'static)>>,

    all_collectible_standard: Option<Vec<&'static (ICard + 'static)>>,
    all_collectible_wild: Option<Vec<&'static (ICard + 'static)>>,

    all_collectible_standard_per_class: Option<HashMap<ECardClasses, Vec<&'static (ICard + 'static)>>>,
    all_collectible_wild_per_class: Option<HashMap<ECardClasses, Vec<&'static (ICard + 'static)>>>
}
